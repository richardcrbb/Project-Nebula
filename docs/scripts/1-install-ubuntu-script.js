...
fetch('./code/keyboard-shortcuts/open-terminal.md', { cache: "no-store" })
  .then(r => {
...
//. lsblk
fetch('./code/commands/1-lsblk.sh', {cache: "no-store"})
.then(r => {
...
//. gdisk
fetch('./code/commands/2-gdisk.sh', {cache: "no-store"})
.then(r =>{
...
//. mkfs
fetch('./code/commands/2.2-mkfs.sh', {cache: 'no-store'})
.then(r =>{
...
//. xz
fetch('./code/commands/3-xz.sh', {cache: 'no-store'})
.then(r =>{
...
//. losetup
fetch('./code/commands/4-losetup.sh', {cache: "no-store"})
.then(r => {
...
//. mkdir
fetch('./code/commands/5-mkdir.sh', {cache: 'no-store'})
.then(r => {
...
//. mount
fetch('./code/commands/6-mount.sh', {cache: 'no-store'})
.then(r => {
...
//. cp
fetch('./code/commands/7-cp.sh', {cache: 'no-store'})
.then(r => {
...
//. ssh
fetch('./code/commands/11-ssh.sh', {cache: 'no-store'})
.then(r =>{
