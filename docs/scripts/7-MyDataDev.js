...
//. create-subvolumes
fetch('./code/commands/67-create-subvolumes.sh', {cache: 'no-store'})
.then(r => {
...
//. mkdir-subvolumes
fetch('./code/commands/68-mkdir-subvol.sh', {cache: 'no-store'})
.then(r => {
...
//. fstabfilesubvol
fetch('./code/commands/69-fstabfilesubvol.sh', {cache: 'no-store'})
.then(r => {
